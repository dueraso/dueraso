              ...
              <v-list-item>
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle>
                    <v-text-field
                      :label="$i18n.t('header').userName" light dense style="margin-top: 12px"
                  ...
                  <v-list-item-subtitle>
                    <v-text-field
                      :label="$i18n.t('header').password" light dense style="margin-top: 12px"
    ...
    return {
      ...
      itemsBar: [
        ...
        },
        {
          ...
          route: this.localeLocation("verification")
        },
        {
