...
export default {
  ...
  mounted() {
    ...
    this.barDataProjects = {
      labels: [...(this._projects && this._projects.map((item) => item.name))],
      datasets: [
        {
          label: '_projects',
          data: [
            ...(this._projects && this._projects.map((item) => item.summary))
          ],
          backgroundColor: [
            ...(this._projects && this._projects.map((item) => item.color))
          ],
